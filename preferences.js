...
(function (root, factory) {
  ...
  const texts = {
    nl: {
      ...
      together: 'Samen', addReceiver: 'Receiver toevoegen', setupStand: 'Mijn stand instellen', settings: 'Instellingen', myColours: 'Mijn kleuren',
      manage: 'Beheren', newColour: 'Nieuwe kleur', saveColour: 'Kleur opslaan', newScene: 'Nieuwe scène', saveScene: 'Scène opslaan',
      colourOrder: 'Volgorde wijzigen', done: 'Klaar', saveCurrentColour: 'Ingestelde kleur toevoegen',
      animationGallery: 'Animatiegalerij',
    ...
    en: {
      ...
      together: 'Together', addReceiver: 'Add receiver', setupStand: 'Set up my booth', settings: 'Settings', myColours: 'My colours',
      manage: 'Manage', newColour: 'New colour', saveColour: 'Save colour', newScene: 'New scene', saveScene: 'Save scene',
    ...
    fr: {
      ...
      together: 'Ensemble', addReceiver: 'Ajouter un récepteur', setupStand: 'Configurer mon stand', settings: 'Réglages', myColours: 'Mes couleurs',
      manage: 'Gérer', newColour: 'Nouvelle couleur', saveColour: 'Enregistrer la couleur', newScene: 'Nouvelle scène', saveScene: 'Enregistrer la scène',
    ...
    de: {
      ...
      together: 'Gemeinsam', addReceiver: 'Empfänger hinzufügen', setupStand: 'Meinen Stand einrichten', settings: 'Einstellungen', myColours: 'Meine Farben',
      manage: 'Verwalten', newColour: 'Neue Farbe', saveColour: 'Farbe speichern', newScene: 'Neue Szene', saveScene: 'Szene speichern',
