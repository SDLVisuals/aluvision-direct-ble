...
(() => {
  ...
  layoutStyle.textContent = `
    ...
    .alv-view-switch .alv-view-chip{display:grid;place-items:center;min-height:31px;padding:0 8px;border-radius:8px;color:#aeb1ac;font-size:8px;font-weight:900;white-space:nowrap}
    .alv-view-switch .alv-view-chip.on{background:#f2f1ed;color:#1b1c1b}
    @media(max-width:720px){
      .alv-inspector-tabs{display:none}
      .alv-target{min-height:44px}
      .alv-view-switch button,.alv-view-switch .alv-view-chip{min-height:40px}
